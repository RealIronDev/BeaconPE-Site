...
<head>
    ...
    <title>PocketBukkit | Stable</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-40 col-md-40 intro-marketing-box">
                    <u><h2>Stable Build Help</h2></u>
                    <p>A Stable Build is a PocketBukkit build that has been confirmed as stable for use on all PocketBukkit servers.  These may still have bugs but will not include things like memory leaks or other major issues.  Stable Builds are the most recommended build type available.</p>
                  </br></br></br></br></br>
                </div>
