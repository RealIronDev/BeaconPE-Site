...
<html lang="en">
  <head>
    ...
    <title>BeaconPE - Error 403</title>
    <!-- Bootstrap core CSS -->
      ...
      <div class="site-wrapper-inner">
        <div class="cover-container">
          ...
          <div class="inner cover">
            <h1 class="cover-heading">You Shall Not Pass</h1>
            <p class="lead">
            	You are not permitted to access this page/file.  If you feel that this is an error, please contact an administrator.
            </p>
          </div>
